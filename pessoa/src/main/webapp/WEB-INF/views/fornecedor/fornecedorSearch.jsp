...
<jump:widget mainicon="icon-search" maintitle="fornecedor.page.title"
             widgettitle="fornecedor.crud.page.title" span="6">
    <form class="form" action="${contexto}/fornecedor/search.do" method="post" id="formSearch">
        <div class="control-group">
            <label class="control-label" for="tipoPessoa"><spring:message
                    code="fornecedor.pessoa.pesTipoPessoa.label"/></label>
        ...
        <div class="control-group">
            <label class="control-label" for="identificacao"><spring:message
                    code="fornecedor.pessoa.pesIdentificacao.label"/></label>
        ...
        <div class="widget-content">
            <div class="padd">
                ...
                <div class="btn-group pull-right">
                    ...
                    <a href="${contexto}/fornecedor/index.do" class="btn"><spring:message
